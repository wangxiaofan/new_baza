...
import com.baza.android.bzw.businesscontroller.search.newfilter.NewFilterPopupWindow;
...
public class NewSearchFilterUI implements ICompanyFilterListener {
    ...
    private ICompanySearchView mSearchView;
    private CompanySearchPresenter mPresenter;
    private NewFilterPopupWindow mFilterPopupWindow;
    ...
    private String mCityNameOutSide, mWorkYearNameOutSide, mDegreeNameOutSide, mMajorOutSide, mCompanyOutSide;
    ...
    public NewSearchFilterUI(View viewMain, ICompanySearchView mSearchView, CompanySearchPresenter mPresenter) {
    ...
    private void showFilterWindow(int type) {
        ...
        switch (type) {
            ...
            case FILTER_DEGREE:
            case FILTER_YEARS:
                mFilterPopupWindow.setOutSideMoreInfo(mWorkYearNameOutSide, mDegreeNameOutSide);
                break;
    ...
    private void initFilterPopupWindow() {
        mFilterPopupWindow = new NewFilterPopupWindow(mSearchView.callGetBindActivity(), this);
    ...
    public void onSortOrderSelected(int sortType) {
        if (mSearchFilterInfo == null)
            return;
        switch (sortType) {
            case CommonConst.COMPANY_RESUME_SEARCH_SORT_ORDER_UPDATE_TIME:
                tvFilterAll.setText("更新时间排序");
                break;
            case CommonConst.COMPANY_RESUME_SEARCH_SORT_ORDER_NONE:
     ...
     */
    protected CompanySearchFilterInfoBean getSearchFilterInfo() {
        return mPresenter.getSearchFilterInfo();
    }

    public void makePreviousDataWhenFilterChangeOutside() {
        CompanySearchFilterInfoBean searchFilterCurrent = getSearchFilterInfo();
