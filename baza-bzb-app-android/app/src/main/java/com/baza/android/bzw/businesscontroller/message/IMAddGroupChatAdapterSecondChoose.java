...
public class IMAddGroupChatAdapterSecondChoose extends BaseAdapter {

    private IMAddGroupChatChooseActivity activity;
    private List<IMGetTeamMembersResponseBean.DataBean> beanList;

    public IMAddGroupChatAdapterSecondChoose(IMAddGroupChatChooseActivity activity, List<IMGetTeamMembersResponseBean.DataBean> beanList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.group_chat_second_rel.setOnClickListener(view1 -> {
            ...
            //更新其他数据
            activity.updateListSelect(beanList.get(i).getUnionId(), beanList.get(i).isChecked());
