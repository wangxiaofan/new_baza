...
public class RecommendDateSetDialog extends BottomSheetDialog implements View.OnClickListener {
    ...
    RecommendDateSetDialog.ITimeSelectedListener timeSelectedListener;

    public RecommendDateSetDialog(@NonNull Context context, Date target, RecommendDateSetDialog.ITimeSelectedListener timeSelectedListener) {
        super(context);
