...
public class NewMoreFilterUI implements CompoundButton.OnCheckedChangeListener, IMoreFilterView {
...
//    private LineBreakLayout lineBreakLayout_sexContainer;
    ...
    private TextView tv_years, tv_degree;//tv_school, tv_source, tv_sex;

    NewMoreFilterUI(Context mContext, ICompanyFilterListener mFilterListener) {
    ...
    public void show(boolean mayReset, String mWorkYearOutSide, String mDegreeOutSide, String mSchoolOutSide, String mSourceOutSide, String mSexOutSide, int type) {
    ...
    private void init() {
        ...
        view_root = mLayoutInflater.inflate(R.layout.layout_filter_more_new, null);
...
//        lineBreakLayout_sexContainer = view_root.findViewById(R.id.lbl_sex_container);
        tv_years = view_root.findViewById(R.id.tv_years);
        tv_degree = view_root.findViewById(R.id.tv_degree);
//        tv_school = view_root.findViewById(R.id.tv_school);
//        tv_source = view_root.findViewById(R.id.tv_source);
//        tv_sex = view_root.findViewById(R.id.tv_sex);
...
//        addSexSelections(itemWidth, itemHeight);
    ...
    private void setContent(int type) {
        switch (type) {
            case NewSearchFilterUI.FILTER_YEARS:
                tv_years.setVisibility(View.VISIBLE);
                lineBreakLayout_workYearsContainer.setVisibility(View.VISIBLE);
                tv_degree.setVisibility(View.GONE);
                lineBreakLayout_degreeContainer.setVisibility(View.GONE);
                break;
            case NewSearchFilterUI.FILTER_DEGREE:
                tv_years.setVisibility(View.GONE);
                lineBreakLayout_workYearsContainer.setVisibility(View.GONE);
                tv_degree.setVisibility(View.VISIBLE);
                lineBreakLayout_degreeContainer.setVisibility(View.VISIBLE);
                break;
        }
    }
    ...
    private void addWorkYearsSelections(int itemWidth, int itemHeight) {
        ...
        for (int i = 0; i < workYearFilters.length; i++) {
            ...
            checkBox = (CheckBox) mLayoutInflater.inflate(R.layout.layout_company_more_filter_item, null);
