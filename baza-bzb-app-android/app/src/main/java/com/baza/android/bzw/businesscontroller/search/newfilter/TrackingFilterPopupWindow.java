...
public class TrackingFilterPopupWindow extends PopupWindow implements ICompanyFilterListener {
    ...
    private TrackingSortFilterUI mSortFilterUI;
    ...
    private String mWorkYearOutSide, mDegreeOutSide, mSortOutSide;
    private ArrayList<Label> mLabelsOutSide;
    private boolean mIsLabelsOutSideEnable;

    public TrackingFilterPopupWindow(Context context, ICompanyFilterListener mListener) {
    ...
    public void setOutSideMoreInfo(String mWorkYearOutSide, String mDegreeOutSide, String mSortOutSide) {
        this.mWorkYearOutSide = mWorkYearOutSide;
        this.mDegreeOutSide = mDegreeOutSide;
        this.mSortOutSide = mSortOutSide;
    }
...
//        showAtLocation(v, Gravity.NO_GRAVITY, 0, yOffset);
    ...
    private void showSort() {
        if (mSortFilterUI == null) {
            mSortFilterUI = new TrackingSortFilterUI(mContext, this);
        ...
        if (mLabelFilterUI != null)
            mLabelFilterUI.hide();
        mSortFilterUI.show(mSortOutSide);
    }
