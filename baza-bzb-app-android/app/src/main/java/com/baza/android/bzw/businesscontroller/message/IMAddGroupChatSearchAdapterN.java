...
public class IMAddGroupChatSearchAdapterN extends BaseAdapter {

    private IMAddGroupChatSearchActivity activity;
    private List<IMGetTeamMembersResponseBean.DataBean> beanList;

    public IMAddGroupChatSearchAdapterN(IMAddGroupChatSearchActivity activity, List<IMGetTeamMembersResponseBean.DataBean> beanList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.group_chat_second_team.setVisibility(View.GONE);
