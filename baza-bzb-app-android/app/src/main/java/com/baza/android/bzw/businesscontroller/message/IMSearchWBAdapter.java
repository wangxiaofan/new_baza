...
public class IMSearchWBAdapter extends BaseAdapter {

    private Context context;
    private List<IMSearchBean.DataBeanX.OuterMemberInfosBean> beanList;
    public boolean isMore;//默认两条，isMore为true展示全部

    public IMSearchWBAdapter(Context context, List<IMSearchBean.DataBeanX.OuterMemberInfosBean> beanList, boolean isMore) {
