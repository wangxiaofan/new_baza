...
public class NewCityFilterUI implements ICityView, BaseBZWAdapter.IAdapterEventsListener, SideBar.OnTouchingLetterChangedListener {
    ...
    public NewCityFilterUI(Context mContext, ICompanyFilterListener mFilterListener) {
