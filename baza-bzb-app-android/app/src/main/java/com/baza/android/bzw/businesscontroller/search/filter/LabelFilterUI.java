...
public class LabelFilterUI implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public LabelFilterUI(Context mContext, IFilterListener mFilterListener, ArrayList<Label> mLabelLibrary) {
