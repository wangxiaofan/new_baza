 ...
 */
@TableAnnotation(tableName = "trackingSearchFilterInfoBean")
public class TrackingSearchFilterInfoBean implements Serializable {
    public static final int FILTER_INT_NONE = -1;
    @ColumnAnnotation(columnName = "id")
    private String id;
    @ColumnAnnotation(columnName = "sort")
    public String sort;
    ...
    public String title;
    @ColumnAnnotation(columnName = "filterType")
    ...
    public void attachSort(String sort) {
        mayChanged = true;
        this.sort = sort;
    }

    public void attachFilterType(String filterType) {
        mayChanged = true;
    ...
    public boolean shouldProcessChanged() {
        if (id == null || searchString == null || mayChanged) {
            ...
            if (!TextUtils.isEmpty(filterType)) {
                stringBuilder.append(filterType).append(doll);
                isJustDefault = false;
            }
...
//            LogUtil.d("tagBindingList  = " + tagBindingList);
    ...
    private boolean isMoreFilterEnable() {
        return ((degreeParameter != FILTER_INT_NONE) || !TextUtils.isEmpty(company) || !TextUtils.isEmpty(title));
    }
