...
//		viewSetText(textView, mSpannableString);
//	}
    public static SpannableString makeSpannableStringEmotion(Context context, SpannableString spannableString) {
        ...
        while (matcher.find()) {
            ...
            if (d != null) {
                spannableString.setSpan(new ImageSpan(d, ImageSpan.ALIGN_BOTTOM), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
        return spannableString;
    }

    public static SpannableString makeStringEmotion(Context context, String value) {
