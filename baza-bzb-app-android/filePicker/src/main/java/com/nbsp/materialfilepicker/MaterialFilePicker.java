...
public class MaterialFilePicker {
    ...
    public static void pickFileUseDefaultMode(Activity activity, String lastPath, int requestCode) {
        new MaterialFilePicker().withActivity(activity).withHiddenFiles(true).withRequestCode(requestCode).withPath(lastPath).start();
    }

    public static String decodePickedFile(Intent data, int resultCode) {
