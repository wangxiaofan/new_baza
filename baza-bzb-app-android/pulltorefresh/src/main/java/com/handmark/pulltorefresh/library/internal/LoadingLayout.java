...
//        }
    ...
    public final void reset() {
        ...
        mHeaderImage.setVisibility(isRebound ? View.GONE : View.VISIBLE);
...
//        }
    ...
    public void reboundState(boolean isRebound) {
        ...
        if (mHeaderProgress != null)
            mHeaderProgress.setVisibility(isRebound ? View.GONE : View.VISIBLE);
        if (mHeaderText != null)
            mHeaderText.setVisibility(isRebound ? View.GONE : View.VISIBLE);
//        if (mSubHeaderText != null)
//            mSubHeaderText.setVisibility(isRebound ? View.GONE : View.VISIBLE);
    }
}
