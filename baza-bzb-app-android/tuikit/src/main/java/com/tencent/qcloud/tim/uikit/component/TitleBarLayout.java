...
public class TitleBarLayout extends LinearLayout implements ITitleBarLayout {
    ...
    private TextView mCenterTitle, mCenterTitleMin;
...
//    private RelativeLayout mTitleLayout;
    ...
    private void init() {
        ...
        mCenterTitleMin = findViewById(R.id.page_title_min);
    ...
    public TextView getmCenterTitleMin() {
        return mCenterTitleMin;
    }

    public void setmCenterTitleMin(TextView mCenterTitleMin) {
        this.mCenterTitleMin = mCenterTitleMin;
    }
