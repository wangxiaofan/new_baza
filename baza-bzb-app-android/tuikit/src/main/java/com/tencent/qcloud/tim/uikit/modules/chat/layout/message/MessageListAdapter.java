...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    private MessageLayout.OnClickListener onClickListener;
    ...
    public MessageLayout.OnClickListener getOnClickListener() {
        return onClickListener;
    }

    public void setOnClickListener(MessageLayout.OnClickListener onClickListener) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        baseHolder.setOnClickListener(onClickListener);
    ...
    public void onViewRecycled(@NonNull RecyclerView.ViewHolder holder) {
        if (holder instanceof MessageContentHolder) {
            ((MessageContentHolder) holder).msgContentFrame.setBackgroundColor(mRecycleView.getResources().getColor(R.color.white));
        }
    }
