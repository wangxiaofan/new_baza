...
public class TUIKitConstants {
    ...
    public static String covert2HTMLStringRed(String original) {
        return "<font color=\"#FF0000\">" + original + "</font>";
    }

    public static String covert2StringHTML(String original) {
        original = original.replace("<font color=\"#5B6B92\">", "");
        original = original.replace("</font>", "");
        return original;
    }
