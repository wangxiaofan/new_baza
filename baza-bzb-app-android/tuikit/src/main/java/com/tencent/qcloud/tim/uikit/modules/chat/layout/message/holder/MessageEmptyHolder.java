...
import com.tencent.qcloud.tim.uikit.utils.DateTimeUtilForDetails;
        ...
        if (position > 1) {
            ...
            if (last != null) {
                if (msg.getMsgTime() - last.getMsgTime() >= 5 * 60) {
                    ...
                    chatTimeText.setText(DateTimeUtilForDetails.getTimeFormatText(new Date(msg.getMsgTime() * 1000)));
                } else {
