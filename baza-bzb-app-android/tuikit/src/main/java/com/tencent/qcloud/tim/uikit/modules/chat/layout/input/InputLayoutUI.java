...
//        mShortcutArea = findViewById(R.id.shortcut_area);
    ...
    protected void assembleActions() {
        ...
        if (!mSendPhotoDisable) {
            action.setIconResId(R.drawable.icon_xiangce);
        ...
        if (!mCaptureDisable) {
            ...
            action.setIconResId(R.drawable.icon_paishe);
        ...
        if (!mVideoRecordDisable) {
            action = new InputMoreActionUnit();
            action.setIconResId(R.drawable.icon_shipin);
        ...
        if (!mSendFileDisable) {
            action = new InputMoreActionUnit();
            action.setIconResId(R.drawable.icon_wenjian);
