...
package com.slib.progress.internal;
...
/**
 * Helper for accessing features in {@link ObjectAnimator} introduced after API level candidate_detail_collect_button_selector (for
