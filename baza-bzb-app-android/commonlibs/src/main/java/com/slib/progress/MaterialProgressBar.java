...
import com.slib.progress.internal.DrawableCompat;


/**
 * A {@link ProgressBar} subclass that handles tasks related to backported mProgress drawable.
 */
public class MaterialProgressBar extends ProgressBar {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        switch (mProgressStyle) {
            ...
            case PROGRESS_STYLE_HORIZONTAL:
                ...
                break;
            default:
                throw new IllegalArgumentException("Unknown mProgress style: " + mProgressStyle);
        }
    ...
    /**
     * Get the style of current mProgress drawable.
     *
     * @return The style of current mProgress drawable.
     */
    ...
    /**
     * Get the mProgress drawable of this ProgressBar.
     *
     * @return The mProgress drawable.
     */
    ...
    /**
     * Get whether the mProgress drawable is using an intrinsic padding. The default is {@code true}.
     *
     * @return Whether the mProgress drawable is using an intrinsic padding.
     * @throws IllegalStateException If the mProgress drawable does not implement
    ...
    /**
     * Set whether the mProgress drawable should use an intrinsic padding. The default is {@code true}.
     *
     * @param useIntrinsicPadding Whether the mProgress drawable should use its intrinsic padding.
     * @throws IllegalStateException If the mProgress drawable does not implement
     * {@link IntrinsicPaddingDrawable}.
     */
    ...
    /**
     * Get whether the mProgress drawable is showing a track. The default is {@code true}.
     *
     * @return Whether the mProgress drawable is showing a track, or {@code false} if the drawable
    ...
    /**
     * Set whether the mProgress drawable should show a track. The default is {@code true}.
     *
     * @param showTrack Whether track should be shown. When {@code false}, does nothing if the
     *                  mProgress drawable does not implement {@link ShowTrackDrawable}. When
     *                  {@code true}, throws {@link IllegalStateException}.
     * @throws IllegalStateException If {@code showTrack} is {@code true} but the mProgress drawable
     * does not implement {@link ShowTrackDrawable}.
     */
    ...
    /**
     * Return the tint applied to the mProgress drawable, if specified.
     *
     * @return The tint applied to the mProgress drawable.
    ...
    /**
     * Applies a tint to the mProgress drawable. Does not modify the current tint mode, which is
    ...
    /**
     * Return the blending mode used to apply the tint to the mProgress drawable, if specified.
     *
     * @return The blending mode used to apply the tint to the mProgress drawable.
     ...
     * {@link #setProgressTintList(ColorStateList)}} to the mProgress drawable. The default mode is
