...
public final class ViewfinderView extends View {
    ...
    private int cornerRectWidth;  //扫描区边角的宽
    private int cornerRectHeight; //扫描区边角的高
    private int scannerLineMoveDistance;  //扫描线移动距离
    private int scannerLineHeight;  //扫描线宽度
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        cornerRectWidth = (int) array.getDimension(R.styleable.ViewfinderView_corner_rect_width, 8f);
        cornerRectHeight = (int) array.getDimension(R.styleable.ViewfinderView_corner_rect_height, 40f);
        scannerLineMoveDistance = (int) array.getDimension(R.styleable.ViewfinderView_scanner_line_move_distance, 5f);
        scannerLineHeight = (int) array.getDimension(R.styleable.ViewfinderView_scanner_line_height, 10f);
...
//        scannerAlpha = 0;
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
        ...
        canvas.drawText(labelText, frame.left + frame.width() / 2, frame.top + frame.height() + cornerRectHeight * 2, paint);
    }
...
//    canvas.drawRect(frame.left + 2, middle - 1, frame.right - 1, middle + 2, paint);
        ...
        RadialGradient radialGradient = new RadialGradient(
                ...
                (float) (scannerStart + scannerLineHeight / 2),
                360f,
                laserColor,
                shadeColor(laserColor),
                Shader.TileMode.MIRROR);
        ...
        SweepGradient sweepGradient = new SweepGradient(
                (float) (frame.left + frame.width() / 2),
                (float) (scannerStart + scannerLineHeight),
                shadeColor(laserColor),
                laserColor);
        ...
        if (scannerStart <= scannerEnd) {
            //矩形
//      canvas.drawRect(frame.left, scannerStart, frame.right, scannerStart + scannerLineHeight, paint);
            //椭圆
