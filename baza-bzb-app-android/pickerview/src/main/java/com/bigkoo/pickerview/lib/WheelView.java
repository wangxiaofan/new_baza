...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (displayMetrics.widthPixels < 1080 || displayMetrics.heightPixels < 1080)
            textSize = getResources().getDimensionPixelSize(R.dimen.pickerview_textsize_s);
        else if (displayMetrics.widthPixels > 2000 || displayMetrics.heightPixels > 2000)
            textSize = getResources().getDimensionPixelSize(R.dimen.pickerview_textsize_b);
        else
            textSize = getResources().getDimensionPixelSize(R.dimen.pickerview_textsize_n);
    ...
    public final void setCurrentItem(int currentItem, boolean noticeSelected) {
